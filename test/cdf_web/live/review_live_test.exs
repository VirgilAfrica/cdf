defmodule CdfWeb.ReviewLiveTest do
  use CdfWeb.ConnCase

  import Phoenix.LiveViewTest
  import Cdf.ReviewsFixtures

  @create_attrs %{description: "some description", date_added: "2025-02-17", percentage_set: 42}
  @update_attrs %{description: "some updated description", date_added: "2025-02-18", percentage_set: 43}
